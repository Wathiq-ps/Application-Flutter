...
class _ListPropertyPhotosScreenState extends State<ListPropertyPhotosScreen> {
                ...
                children: [
                  ...
                  SubmitButtonWidget(
                    ...
                    onPressed: () {
                      if (_photos.isEmpty) {
                        setState(() {
                          _photoError = 'Please add at least one photo';
                        });
                        return;
                      }
                      context.read<CreatePropertyCubit>().saveStep4(
